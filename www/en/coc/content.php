<div>
    ...
    <div class="coc">
      ...
      <h3>Purpose</h3>
      <p>
        A primary goal of all nullaufeins e.V. organized events, hackathons,
        meetups is to be inclusive to the largest number of contributors, with
        the most varied and diverse backgrounds possible. As such, we are
        committed to providing a friendly, safe and welcoming environment for
        all, regardless of race, ethnicity, culture, national origin, colour,
      ...
      <p>
        This Code of Conduct is based on the <a href="http://berlincodeofconduct.org/">Berlin Code of Conduct</a>. Both are distributed under the <a href="http://creativecommons.org/licenses/by-sa/3.0/">Creative Commons Attribution-ShareAlike license in its latest version</a>.
      </p>

      <h3>Code of Conduct Team</h3>
      <p>
        If a Code of Conduct incident happens to you, or you witness it
        happening to someone else, please contact the organizer team immediately
        either in person, or by sending an email to <a href="mailto:events@nullaufeins.org">events@nullaufeins.org</a>. The organizers will be introduced in person at the events or meetups.
        You can approach them at any time to discuss an incident or concern.
      </p>
